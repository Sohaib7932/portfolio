...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      icon: (
        <svg className='w-5 h-5' fill='currentColor' viewBox='0 0 24 24'>
          <path d='M23 9h-4v1h4v1h-4v1h4v1h-4v1h4v1h-4v1h4v1h-4v1h4v1h-4v1h4v1h-4v1h4v1h-4v1h4v1h-4v1h4v1h1V9zm-6 7.5c0-1.4-1.1-2.5-2.5-2.5S12 15.1 12 16.5s1.1 2.5 2.5 2.5 2.5-1.1 2.5-2.5zm-6 0c0-1.4-1.1-2.5-2.5-2.5S6 15.1 6 16.5s1.1 2.5 2.5 2.5 2.5-1.1 2.5-2.5zm-6 0c0-1.4-1.1-2.5-2.5-2.5S0 15.1 0 16.5s1.1 2.5 2.5 2.5 2.5-1.1 2.5-2.5zM14.5 5C13.1 5 12 6.1 12 7.5S13.1 10 14.5 10 17 8.9 17 7.5 15.9 5 14.5 5z'/>
        </svg>
      )
    },
    {
